...
namespace osu.Game.Screens.Menu
{
    ...
    /// </summary>
    public partial class ClassicLogoVisualisation : Drawable
    {
        /// <summary>
        /// The number of bars to jump each update iteration.
        /// </summary>
        private const int index_change = 0;
        ...
        /// </summary>
        private const int bars_per_visualiser = 120;

        /// <summary>
        /// How many times we should stretch around the circumference (overlapping overselves).
        /// </summary>
        private const float visualiser_rounds = 1;
        ...
        public ClassicLogoVisualisation()
        {
        ...
        {
            protected new ClassicLogoVisualisation Source => (ClassicLogoVisualisation)base.Source;
            ...
            private static readonly Color4 transparent_white = Color4.White.Opacity(0.5f);

            private readonly float[] audioData = new float[256];

            private IVertexBatch<TexturedVertex2D>? vertexBatch;

            public VisualisationDrawNode(ClassicLogoVisualisation source)
                : base(source)
            {
            }
