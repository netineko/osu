...
{
    public partial class OnlineStatusPill : CircularContainer, IHasTooltip, ISerialisableDrawable
    {
        ...
        protected override void LoadComplete()
        {
            ...
            {
                status = b.NewValue.BeatmapInfo.Status;
                updateState();
            }, true);
        ...
        {
            double duration = animation_duration;
